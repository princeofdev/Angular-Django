...
class Migration(migrations.Migration):
    ...
    dependencies = [
        ('services', '0010_auto_20171205_1415'),
    ]
    ...
    operations = [
        migrations.AddField(
            ...
            name='credit_card',
            field=models.CharField(default=0, max_length=255, validators=[services.validators.check_credit_card]),
            preserve_default=False,
        ),
        migrations.AddField(
            model_name='hireservice',
            name='total',
            field=djmoney.models.fields.MoneyField(decimal_places=2, default=Decimal('0.0'), default_currency='CHF', max_digits=10),
        ),
        migrations.AddField(
            model_name='hireservice',
            name='total_currency',
