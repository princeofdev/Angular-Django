# -*- coding: utf-8 -*-
# Generated by Django 1.11.7 on 2017-11-24 09:59
    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('price', djmoney.models.fields.MoneyField(decimal_places=2, default=Decimal('0.0'), default_currency='CHF', max_digits=10)),
                ('city', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='cities', to='geo.City', verbose_name='City')),
            ],
        ),
        ...
        migrations.AddField(
            ...
            name='service',
            field=models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='city_services', to='services.Service', verbose_name='Service'),
        ),
    ]
